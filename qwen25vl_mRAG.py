...
from utils.utils import (
    ...
    clear_memory,
    save_images_to_local_wo_resize,
    load_png_images,
    images_to_base64,
    get_grouped_images,
    process_ranker_results,
)

MODEL_PATH = "./models/qwen2.5vl"
PDF_PATH = "./data/pdf"
RERANK_MODEL_PATH = "./models/MonoQwen2-VL-v0.1"
RETRIEVAL_MODEL_PATH = "./models/colqwen2-v1.0"
DATA_PATH = "./data/mrag/pdfvqa"
IMAGE_PATH = "./data/mrag/images"
TMP_PATH = "./aaa/tmp"
SUBSET = -1
PREPROCESS = -1
INPUT_PDF = 1
...
while True:
    ...
    grouped_images = process_ranker_results(
        results, grouped_images, top_k=reranker_top_k
    )
